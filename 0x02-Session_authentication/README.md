...
### 3. What does `models/user_session.py` do?
...
-   GitHub repository: `alx-backend-user-data`
-   Directory: `0x02-Session_authentication`
-   File: `models/user_session.py`

### 4. What does `api/v1/app.py` do?
...
### 5. What does `api/v1/auth/auth.py` do?
...
### 6. What does `api/v1/auth/basic_auth.py` do?
...
### 7. What does `api/v1/auth/session_auth.py` do?
...
### 8. What does `api/v1/auth/session_exp_auth.py` do?
...
### 9. What does `api/v1/auth/session_db_auth.py` do?
...
-   GitHub repository: `alx-backend-user-data`
-   Directory: `0x02-Session_authentication`
-   File: `api/v1/auth/session_db_auth.py`

### 10. What does `api/v1/views/session_auth.py` do?
...
### 11. What do `api/v1/views/index.py` and `api/v1/views/users.py` do?
...
-   GitHub repository: `alx-backend-user-data`
-   Directory: `0x02-Session_authentication`
-   File: `api/v1/views/index.py`, `api/v1/views/users.py`
